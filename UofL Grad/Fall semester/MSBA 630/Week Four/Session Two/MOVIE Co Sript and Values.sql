...
--Order for droping tables in MovieCo
...
CONSTRAINT FK_Movie FOREIGN KEY(PRICE_CODE) REFERENCES PRICE(PRICE_CODE)
...
CONSTRAINT FK_Video_Movie FOREIGN KEY(MOVIE_NUM) REFERENCES MOVIE(MOVIE_NUM)
...
CONSTRAINT  FK_Rental_Membership  FOREIGN KEY (MEM_NUM) REFERENCES MEMBERSHIP(MEM_NUM)
...
ADD  CONSTRAINT  DETAIL_RENT_VID_PK PRIMARY KEY (RENT_NUM, VID_NUM),

CONSTRAINT FK_DETAILRENTAL_RENTAL FOREIGN KEY (Rent_Num)
REFERENCES RENTAL (RENT_NUM),

CONSTRAINT FK_DETAILRENTAL_VIDEO FOREIGN KEY(Vid_Num)
